...
class custom_trainer(Trainer):
    ...
    def evaluation_loop(
        ...
        Note: Modify from transformers/train.py -> add support for List like labels to evaluate
        batch of single generated sentences against batch of a group of reference sentences.
        """
        args = self.args
        ...
        for step, inputs in enumerate(dataloader):
            ...
            if labels is not None and not isinstance(labels,list): # add here
